...
.. topic:: Extending the Variational Form Library
    ...
    are pluggable modules in Aqua. This is done in order to encourage researchers and developers interested in
    quantum algorithms to extend the Aqua framework with their novel research contributions.
    ...
    Aqua also allows for new components to register themselves as Aqua extensions and be dynamically
...
.. note::
    ...
    When executing a Aqua Chemistry problem, the user can configure two parameters in the ``operator``
