...
class TestSVMClassical(QiskitAquaTestCase):
    ...
    def test_classical_binary(self):
       ...
       [ 0.06183066, -0.53376975]])}
        ...
        self.assertEqual(result['test_success_ratio'], 1.0)
        self.assertEqual(result['predicted_labels'], ['A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B'])
    ...
    def test_classical_multiclass_one_against_all(self):
       ...
       [-0.66489165,  0.1181712 ]])}
        ...
        result = run_algorithm(params, algo_input)
        self.assertEqual(result['test_success_ratio'], 1.0)
        self.assertEqual(result['predicted_labels'], ['A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'A', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'B', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C', 'C'])
