...
from qiskit.finance import __path__ as qiskit_finance_path


class Path(Enum):
    """Helper with paths commonly used during the tests."""
    # Main SDK path:    qiskit/finance/
    SDK = qiskit_finance_path[0]
    # test.python path: test/finance
    TEST = os.path.dirname(__file__)


class QiskitFinanceTestCase(unittest.TestCase):
