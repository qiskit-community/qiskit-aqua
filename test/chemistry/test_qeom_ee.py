...
class TestEomEE(QiskitAquaTestCase):
    ...
    def test_h2_four_qubits(self):
        ...
        eom_ee = QEomEE(qubit_op, None, num_orbitals=num_orbitals, num_particles=num_particles, qubit_mapping=qubit_mapping,
                        two_qubit_reduction=two_qubit_reduction)
        result = eom_ee.run()
    ...
    def test_h2_one_qubit(self):
        ...
        eom_ee = QEomEE(tapered_op, None, num_orbitals=num_orbitals, num_particles=num_particles, qubit_mapping=qubit_mapping,
                        two_qubit_reduction=two_qubit_reduction, z2_symmetries=tapered_op.z2_symmetries,
