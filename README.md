...
configuration depends on the specific driver being used. See the chemistry drivers [readme](qiskit_acqua_chemistry/drivers)
...
Here is an example using the [PYSCF driver](qiskit_acqua_chemistry/drivers/pyscfd). The DRIVER section names PYSCF as the
...
Here is another example using the [PSI4 driver](qiskit_acqua_chemistry/drivers/psi4d). Here PSI4 is named as the driver to be
