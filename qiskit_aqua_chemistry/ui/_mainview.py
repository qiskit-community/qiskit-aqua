...
import webbrowser
from qiskit_aqua_chemistry.ui._controller import Controller
from qiskit_aqua_chemistry.ui._sectionsview import SectionsView
from qiskit_aqua_chemistry.ui._sectionpropertiesview import SectionPropertiesView
from qiskit_aqua_chemistry.ui._sectiontextview import SectionTextView
from qiskit_aqua_chemistry.ui._threadsafeoutputview import ThreadSafeOutputView
...
class MainView(ttk.Frame):
    ...
    def _makeToolBar(self):
        ...
        checkButton = ttk.Checkbutton(toolbar,
                                      ...
                                      variable=self._controller._save_algo_json)
    ...
    def _export_dictionary_to_clipboard(self):
        ...
        self._controller.export_dictionary_to_clipboard(self)
