...
class PauliGraphNew(object):
    ...
    def __init__(self, paulis, mode="largest-degree"):
        ...
        self._grouped_paulis, self.graph = self._coloring(mode)
    ...
    def _create_edges(self):
        ...
        """
        Now this code also checks for cases where even though i and j do not commute,
        Pi*Pj = -Pj*Pi, so if the number of these cases is even, the negative signs
        cancel out and the result will still be commutative.
        """
