...
class Ansatz:
    ...
    def append(self, gate: Union[Gate, QuantumCircuit], qubit_indices: Optional[List[int]]):
        ...
        if isinstance(gate, QuantumCircuit):
            num_qubits = gate.n_qubits  # QuantumCircuit calls it n_qubits, not num_qubits
        else:
            num_qubits = gate.num_qubits

        qubit_indices = qubit_indices or list(range(num_qubits))
        self._circuit.append(gate, qubit_indices, [])
