...
# Converts portfolio diversification instances into Pauli list
# For details, please see the tutorial at: 
# https://github.com/Qiskit/qiskit-tutorials/finance/optimization
