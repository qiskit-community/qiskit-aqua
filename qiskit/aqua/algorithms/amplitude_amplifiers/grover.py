...
class Grover(QuantumAlgorithm):
    ...
    def __init__(self,
        ...
        Args:
            ...
            lam: For incremental search mode, the maximum number of repetition of amplitude amplification
                 increases by factor lam in every round, :math: `R_{i+1} = lam \times R_{i}`.
                 If this parameter is not set, the default value lam = 1.34 is used, which is proved to be optimal [1].
        ...
        References:
            [1]: Baritompa et al., `Grover's Quantum Algorithm Applied to Global Optimization <https://www.researchgate.net/publication/220133694_Grover%27s_Quantum_Algorithm_Applied_to_Global_Optimization>`_
            [2]: Boyer et al., `Tight bounds on quantum searching <https://arxiv.org/abs/quant-ph/9605034>`
        """
