    ...
    def _run(self):
        if self._incremental:
            ...
            if self._rotation_counts:
                target_num_iterations = 0
                while self._rotation_counts and target_num_iterations < self._max_num_iterations:
                    target_num_iterations = self._rotation_counts.pop(0)
