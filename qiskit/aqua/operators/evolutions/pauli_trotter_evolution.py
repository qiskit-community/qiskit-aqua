    ...
    def _recursive_convert(self, operator: OperatorBase) -> OperatorBase:
        if isinstance(operator, EvolvedOp):
            ...
            if isinstance(operator.primitive, SummedOp):
                ...
                # Collect the coefficients of any identity terms, which become global phases when exponentiated.
                ...
                circuit_no_identities.primitive.global_phase = -sum(identity_phases)
