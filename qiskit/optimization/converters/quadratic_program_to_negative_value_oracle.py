...
class QuadraticProgramToNegativeValueOracle:
    ...
    def encode(self, problem: QuadraticProgram) -> \
        ...
        a_operator_circuit = QuantumCircuit(key_val)
        a_operator_circuit.h(key_val)
        a_operator_circuit.compose(quadratic_form, inplace=True)
        if self._measurement:
            a_operator_circuit.measure_all()
        ...
        key_val = QuantumRegister(a_operator_circuit.num_qubits, 'key_value')
