...
# -*- coding: utf-8 -*-
#
# Qiskit Chemistry documentation build configuration file, created by
...
project = 'Qiskit Chemistry'
copyright = '2018 IBM'
author = 'IBM'

# Add description
html_context = {
    'description': 'Qiskit Chemistry'
}
...
latex_documents = [
    (master_doc, 'QiskitAquaChemistry.tex', 'Qiskit Chemistry Documentation',
