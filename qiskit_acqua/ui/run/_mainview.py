...
from qiskit_acqua.ui.run._controller import Controller
from qiskit_acqua.ui.run._sectionsview import SectionsView
from qiskit_acqua.ui.run._sectionpropertiesview import SectionPropertiesView
from qiskit_acqua.ui.run._sectiontextview import SectionTextView
from qiskit_acqua.ui.run._threadsafeoutputview import ThreadSafeOutputView
from qiskit_acqua.ui.run._emptyview import EmptyView
from qiskit_acqua.ui.run._preferencesdialog import PreferencesDialog
...
class MainView(ttk.Frame):
    ...
    def _makeMenuBar(self):
        ...
        if sys.platform == 'darwin':
            ...
            app_menu.add_command(label='About QISKit ACQUA',command=self._show_about_dialog)
